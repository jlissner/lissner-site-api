      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            (0, _forEach3.default)(data.ingredients, function (ingredient) {
              return ingredient.title = ingredient.title ? ingredient.title : null;
            });
            (0, _forEach3.default)(data.directions, function (direction) {
              return direction.title = direction.title ? direction.title : null;
            });
            Item = {
              Id: _uuid2.default.v4(),
              recipeUrl: '/' + (0, _kebabCase3.default)(data.title),
          ...
          case 0:
            ...
            params = {
              ...
              ExpressionAttributeValues: {
                ...
                ":directions": data.directions || null,
                ":tags": data.tags || null,
                ":recipeUrl": '/' + (0, _kebabCase3.default)(data.title) || null,
